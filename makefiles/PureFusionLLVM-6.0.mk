#
# Copyright (C) 2018 PureFusionLLVM
#
...
# Export variables for PureFusionLLVM
export LLVM_PREBUILTS_VERSION := 6.0
export LLVM_PREBUILTS_BASE := prebuilts/clang/host
export LLVM_PREBUILTS_PATH := $(LLVM_PREBUILTS_BASE)/$(BUILD_OS)-x86/$(PFLLVM_VERSION)/bin
...
export LLVM_INCLUDES := $(LLVM_PREBUILTS_BASE)/$(BUILD_OS)-x86/$(PFLLVM_VERSION)/lib64/clang/6.0%/include
